...
if (!createDirectorySync(path_cache)) path_cache = null
...
var isFileCached = function(file)
{
	...
	var cacheFileName = path_cache + sep + file.replace(new RegExp(sep.replace("\\", "\\\\"), "g"), "-").replace(/:/g, "-")
...
module.exports = {
	...
	getFileCachedVersion   : getFileCachedVersion,
	writeFileCachedVersion : writeFileCachedVersion
}